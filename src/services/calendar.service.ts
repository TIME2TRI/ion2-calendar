...
export class CalendarService {
  ...
  createCalendarDay(
    ...
    return {
      ...
      showCircle: dayConfig ? dayConfig.showCircle : false,
      showCircleOutline: dayConfig ? dayConfig.showCircleOutline : false,
      backgroundColor: dayConfig ? dayConfig.backgroundColor : "",
      borderColor: dayConfig ? dayConfig.borderColor : "",
      circleItems: dayConfig ? dayConfig.circleItems : null,
      disable: _disable,
      isFirst: date.date() === 1,
